...
class PaymentBreakdown extends Step {
    ...
    handleGet(ctx, formdata) {
        logger.info('handleGet method initiated for /payment-breakdown for case id: ' + (typeof ctx.ccdCase.id !== 'undefined' ? ctx.ccdCase.id : ''));
        ...
        'total fee: ' + ctx.total + ', for case id: ' + (typeof ctx.ccdCase.id !== 'undefined' ? ctx.ccdCase.id : ''));
    ...
    createCopiesLayout(formdata) {
        ...
        ' respectively, for case id: ' + (typeof formdata.ccdCase.id !== 'undefined' ? formdata.ccdCase.id : ''));
        return {
    ...
    * handlePost(ctx, errors, formdata, session, hostname) {
        logger.info('handlePost method initiated for /payment-breakdown for case id: ' + (typeof ctx.ccdCase.id !== 'undefined' ? ctx.ccdCase.id : ''));
        try {
            ...
            if (ctx.total > 0 && canCreatePayment) {
                ...
                (typeof ctx.ccdCase.id !== 'undefined' ? ctx.ccdCase.id : ''));
            } else {
