...
describe('setJourney', () => {
    describe('setJourney()', () => {
        ...
        it('should set req.journey with the probate journey if feature toggle is off and caseType is probate', (done) => {
            const revert = setJourney.__set__('probateJourney', {journey: 'a probate journey'});
            const req = {
                session: {
                    form: {
        ...
        it('should set req.journey with the intestacy journey if feature toggle is on and caseType is intestacy', (done) => {
            const revert = setJourney.__set__('intestacyJourney', {journey: 'an intestacy journey'});
            const req = {
                session: {
                    form: {
