...
export const testConfig = {
  ...
  TestE2EFrontendUrl: 'https://probate-frontend-pr-2734.preview.platform.hmcts.net',
  TestFrontendUrl: 'https://probate-frontend-pr-2734.preview.platform.hmcts.net',
  ...
  TestBase1Url: 'http://ccd-data-store-api-aat.service.core-compute-aat.internal',
  TestBaseUrl: 'https://ccd-data-store-api-probate-back-office-pr-3630.preview.platform.hmcts.net',
  TestS2sUrl: 'http://rpe-service-auth-provider-aat.service.core-compute-aat.internal/testing-support/lease',
  TestBoIdamUrl: 'https://idam-api.aat.platform.hmcts.net',
  CwEmail: 'probatecaseworker@gmail.com',
  CwPassword: 'Monday01',
