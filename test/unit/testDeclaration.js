    ...
    describe('executorsApplying()', () => {
        ...
        it('should return the correct data when there are no codicils', (done) => {
            ...
            expect(data).to.deep.equal([{
                name: 'Applicant Current Name, an executor named in the will as Applicant Current Name, is applying for probate. Their name is different because Applicant Current Name changed their name by deed poll.',
        ...
        it('should return the correct data when there is 1 codicils', (done) => {
            ...
            expect(data).to.deep.equal([{
                name: 'Applicant Current Name, an executor named in the will or codicils as Applicant Current Name, is applying for probate. Their name is different because Applicant Current Name changed their name by deed poll.',
