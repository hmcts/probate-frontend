...
describe('all-whole-sibling-over-18', () => {
    ...
    describe('Verify Content, Errors and Redirection', () => {
        testCommonContent.runTest('AllWholeSiblingsOver18', null, null, [], false, {type: caseTypes.INTESTACY});
