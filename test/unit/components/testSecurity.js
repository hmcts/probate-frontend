...
//         xit('should redirect to login page when security cookie not defined', () => {
//             req.protocol = 'http';
//             req.originalUrl = '/';
...
//         xit('should redirect to login page when cookies null or undefined', () => {
//             req.cookies = null;
//             req.protocol = 'http';
//             req.originalUrl = '/';
...
//         xit('should redirect to login page when IdamSession.get() returns Unauthorized', (done) => {
...
//         xit('should redirect to time-out page when session is lost', (done) => {
//             const revert = Security.__set__('IdamSession', class {
//                 get() {
//                     return promise;
//                 }
...
//         xit('should redirect to time-out page when session has expired', (done) => {
//             const revert = Security.__set__('IdamSession', class {
//                 get() {
//                     return promise;
//                 }
...
//         xit('should deny access when user roles do not match resource role', (done) => {
//             const revert = Security.__set__('IdamSession', class {
//                 get() {
//                     return promise;
//                 }
...
//         xit('should grant access when user roles do match resource role - pa', (done) => {
//             const revert = Security.__set__('IdamSession', class {
//                 get() {
//                     return promise;
//                 }
...
//         xit('should add the auth cookie to the response', (done) => {
//             req.protocol = 'http';
...
//         xit('should make the auth cookie secure if the protocol is https', () => {
//             req.protocol = 'https';
//             req.cookies.__redirect = JSON.stringify({state: 'testState'});
