...
class TaskList extends Step {
    ...
    getContextData(req, res) {
        ...
        if (ctx.caseType === caseTypes.GOP) {
            ...
            logger.info('Declaration status for case id ' + (typeof ctx.ccdCase !== 'undefined' ? ctx.ccdCase.id : '') + ': ' + ctx.declarationStatuses);
            ...
            logger.info('Previous task statuses for case id ' + (typeof ctx.ccdCase !== 'undefined' ? ctx.ccdCase.id : '') + ': DeceasedTask - ' + ctx.DeceasedTask.status + ', ExecutorsTask - ' + ctx.DeceasedTask.status + ', ReviewAndConfirmTask - ' +
            ...
            logger.info('Previous task statuses for case id ' + (typeof ctx.ccdCase !== 'undefined' ? ctx.ccdCase.id : '') + ': DeceasedTask - ' + ctx.DeceasedTask.status + ', ApplicantsTask - ' + ctx.DeceasedTask.status + ', ReviewAndConfirmTask - ' +
