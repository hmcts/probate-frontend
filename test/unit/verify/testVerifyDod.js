...
const VerifyDod = steps.VerifyDod;
const content = require('app/resources/en/translation/verify/verifydod');

describe('VerifyDod', () => {
    describe('dateName()', () => {
        it('should return the date names array', (done) => {
            const dateName = VerifyDod.dateName();
    ...
    describe('getUrl()', () => {
        it('should return the correct url', (done) => {
            const url = VerifyDod.constructor.getUrl();
            expect(url).to.equal('/verify-dod');
            done();
        });
    });
    ...
    describe('handlePost()', () => {
        ...
        it('should return the error for DoD not equals to the Deceased', (done) => {
            ctx = {
                'dod-day': '03',
                'dod-month': '03',
                'dod-year': '1952'
    ...
    describe('getContextData()', () => {
        ...
        it('should return the context with the deceased name', (done) => {
            ...
            ctx = VerifyDod.getContextData(req);
