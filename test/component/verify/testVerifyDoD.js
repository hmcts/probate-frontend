...
const CoApplicantDeclaration = require('app/steps/ui/coapplicant/declaration');
const caseTypes = require('app/utils/CaseTypes');

describe('verify-dod', () => {
    let testWrapper;
    const expectedNextUrlForCoApplicantDeclaration = CoApplicantDeclaration.getUrl();

    beforeEach(() => {
        testWrapper = new TestWrapper('VerifyDod');
    });
    ...
    describe('Verify Content, Errors and Redirection', () => {
        it('test right content loaded on the page', (done) => {
            ...
            testWrapper.agent.post('/prepare-session/form')
                .send(sessionData)
                .end(() => {
                    testWrapper.testContent(done, {deceasedName: 'John Doe', applicantName: 'John Doe'}, contentToExclude);
                });
        });
