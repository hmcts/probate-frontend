...
const SubmittedToHmrcBeforeThreshold = steps.SubmittedToHmrcBeforeThreshold;
const probateJourney = require('app/journeys/probate');

describe('SubmittedToHmrcBeforeThreshold', () => {
    describe('getUrl()', () => {
        it('should return the correct url', (done) => {
            const url = SubmittedToHmrcBeforeThreshold.constructor.getUrl();
            expect(url).to.equal('/submitted-to-hmrc-before-threshold');
            done();
        });
    });
    ...
    describe('next()', () => {
        it('should set nextStep to IhtEstateValued when optionIHT400', (done) => {
            ...
            const returnedStep = SubmittedToHmrcBeforeThreshold.next(req, ctx);
    ...
    describe('nextStepOptions()', () => {
        it('should return the correct next step options', (done) => {
            const result = SubmittedToHmrcBeforeThreshold.nextStepOptions();
