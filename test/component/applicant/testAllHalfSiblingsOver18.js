...
describe('all-half-sibling-over-18', () => {
    ...
    describe('Verify Content, Errors and Redirection', () => {
        ...
        it(`test it redirects to Applicant name page if deceased half-sibling were all over 18 and sibling is applying: /intestacy${expectedNextUrlForApplicantName}`, (done) => {
            const sessionData = {
        ...
        it(`test it redirects to Stop page if some deceased half-sibling were under 18: /intestacy${expectedNextUrlForStopPage}`, (done) => {
            testWrapper.agent.post('/prepare-session/form')
