...
describe('AssetsThreshold.js', () => {
    describe('getIhtThreshold()', () => {
        it('should return the correct IHT threshold for dates before 1 Oct 2014', (done) => {
            ...
            expect(IhtThreshold.getAssetsThreshold(date)).to.equal(null);
            done();
        });

        it('should return the correct IHT threshold for date equal to 1 Oct 2014', (done) => {
            const date = '2014-10-01';
            expect(IhtThreshold.getAssetsThreshold(date)).to.equal(250000);
            done();
        });
        ...
        it('should return the correct IHT threshold for date equal to 6 Feb 2020', (done) => {
            ...
            expect(IhtThreshold.getAssetsThreshold(date)).to.equal(270000);
            done();
        });
        ...
        it('should return the correct IHT threshold for dates on 26 July 2023', (done) => {
            ...
            expect(IhtThreshold.getAssetsThreshold(date)).to.equal(322000);
            done();
        });
