...
class UIStepRunner {
    ...
    handlePost(step, req, res) {
        ...
        return co(function * () {
            ...
            console.log('isEmptyForm:' + isEmptyForm.toString() + 'isSaveAndClose:' + isSaveAndClose.toString());
            if (isEmptyForm && isSaveAndClose) {
                ...
                if (isEmpty(errors)) {
                    ...
                    console.log('errorOccurred: ' + errorOccurred.toString() + ' nextStepUrl: ' + nextStepUrl.toString());
