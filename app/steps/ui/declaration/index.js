...
class Declaration extends ValidationStep {
    ...
    * validateFormData(data, ctx, req) {
    ...
    executorsApplyingText(props) {
        ...
        const aliasSuffix = (typeof props.executor.nameAsOnTheWill !== 'undefined' && !props.executor.nameAsOnTheWill) || props.executor.currentName ? '-alias' : '';
        ...
        const content = {
            name: props.content[`applicantName${props.multipleApplicantSuffix}${mainApplicantSuffix}${aliasSuffix}${codicilsSuffix}`]
                .replace('{applicantWillName}', props.executor.isApplicant && (typeof props.executor.nameAsOnTheWill !== 'undefined' && !props.executor.nameAsOnTheWill) ? FormatName.applicantWillName(props.executor) : props.mainApplicantName)
