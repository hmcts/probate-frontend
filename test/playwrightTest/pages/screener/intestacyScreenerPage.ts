...
export class IntestacyScreenerPage extends BasePage {
  ...
  async startApplication(language: string = 'en', checkCookies: boolean = false): Promise<void> {
  ...
  async selectEEDeceasedDod(language: string = 'en', answer: string = ''): Promise<void> {
  ...
  async selectIhtCompleted(language: string = 'en', answer: string = ''): Promise<void> {
  ...
  async selectDeathCertificate(language: string = 'en', testSurvey: boolean = false): Promise<void> {
  ...
  async selectDeathCertificateInEnglish(language: string = 'en', answer: string = ''): Promise<void> {
...
async selectDeathCertificateTranslation(language: string = 'en', answer: string = ''): Promise<void> {
...
async selectDeceasedDomicile(language: string = 'en'): Promise<void> {
...
async selectPersonWhoDiedLeftAWill(language: string = 'en', answer: string = ''): Promise<void> {
...
async selectDiedAfterOctober2014(language: string = 'en', answer: string = ''): Promise<void> {
...
async selectRelatedToDeceased(language: string = 'en', answer: string = ''): Promise<void> {
...
async startApply(language: string = 'en'): Promise<void> {
...
async switchToNextTab(tabIndex: number): Promise<void> {
